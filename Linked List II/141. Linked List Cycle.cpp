...
// Solution optimised using slow and fast pointers
...
// Solution using map. find node in map if it is present then return cycle else insert in map. return no cycle in last
